...
def mock_doccano_create_project():
    project = Project(id=1, name="Fake name", description="Fake description", 
        guideline="fake guideline", project_type=ProjectType.IMAGE_CLASSIFICATION,
        random_order=False, collaborative_annotation=False, single_class_classification=False,
        allow_overlapping=False, grapheme_mode=False)
...
def mock_doccano_existing_category_types():
    ...
    a_category_type = CategoryType(id=1, text="fake category", 
    background_color="#3d3bc6", text_color="#ffffff")
...
def mock_doccano_search_users():
    ...
    another_fake_user = User(id=21, username="fakeuser2", is_superuser=False, is_staff=False)
